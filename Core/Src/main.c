...
//  HAL_ADCEx_Calibration_Start(&hadc1);
  ...
  ST7735_WriteString(10, 10, "ST7735", Font_11x18, WHITE, BLACK);
  ST7735_WriteString(10, 30, "DMA Demo", Font_11x18, CYAN, BLACK);
  ST7735_WriteString(10, 50, "STM32F401", Font_11x18, YELLOW, BLACK);
