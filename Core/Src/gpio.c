...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, TFT_AD_Pin|TFT_RST_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : TFT_AD_Pin TFT_RST_Pin */
  GPIO_InitStruct.Pin = TFT_AD_Pin|TFT_RST_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pins : SW_AUX2_Pin SW_AUX3_Pin SW_AUX4_Pin */
  GPIO_InitStruct.Pin = SW_AUX2_Pin|SW_AUX3_Pin|SW_AUX4_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
