...
#define TFT_AD_Pin GPIO_PIN_12
#define TFT_AD_GPIO_Port GPIOB
...
#define SW_ARM_Pin GPIO_PIN_15
#define SW_ARM_GPIO_Port GPIOA
#define SW_AUX2_Pin GPIO_PIN_3
#define SW_AUX2_GPIO_Port GPIOB
#define SW_AUX3_Pin GPIO_PIN_4
#define SW_AUX3_GPIO_Port GPIOB
#define SW_AUX4_Pin GPIO_PIN_5
#define SW_AUX4_GPIO_Port GPIOB
